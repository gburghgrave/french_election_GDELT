...
path = '/Users/gabriel/Desktop/DATASET_election/tmp'
    ...
    def InsertData(self):
        ...
        for file in os.listdir(path):
            ...
            if file.lower().endswith(".csv"):
                print(file)
                df = pd.read_csv(path + "/" + file, sep='\t', low_memory=False, header=None,
...
if __name__ == "__main__":
    mongodb = MongoDB(dbName='GDELT', collectionName='Election')
    mongodb.InsertData()
