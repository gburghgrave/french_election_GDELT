...
dateRange = pd.date_range(
    start='2017-12-01', end='2017-12-31', freq='1D').tolist()
...
both_urls = [((gdelturl % ts.strftime('%Y%m%d')),
              "/Users/gabriel/Desktop/DATASET_election/") for ts in dateRange]
...
def download_files(both_urls):
    ...
    for url, local_url, error in results:
        if error is None:
            ...
            z.extractall(path='/Users/gabriel/Desktop/DATASET_election/'+'tmp/')
...
print("->", len(both_urls), "documents downloaded.")
print("Finished!")
